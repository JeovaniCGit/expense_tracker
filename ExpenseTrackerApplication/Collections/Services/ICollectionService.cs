...
public interface ICollectionService
{
    ...
    Task<ErrorOr<IEnumerable<GetCollectionResponseDto>>> GetAllUserCollections(DateTimeOffset? startDate, DateTimeOffset? endDate, CancellationToken ctoken = default);
}
